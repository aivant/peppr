...
_METRICS = {
    ...
    "intra-ligand-lddt": IntraLigandLDDTScore(),
    "lddt-pli": LDDTPLIScore(),
    "lddt-ppi": LDDTPPIScore(),
    "global-lddt": GlobalLDDTScore(),
    "dockq": DockQScore(),
    "ligand-rmsd": LigandRMSD(),
    "interface-rmsd": InterfaceRMSD(),
    "contact-fraction": ContactFraction(),
    "pocket-aligned-ligand-rmsd": PocketAlignedLigandRMSD(),
